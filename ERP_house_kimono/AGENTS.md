...
Últimas implementações: Batch 1 UX improvements + Batch 2 (navbar, dashboard) + Batch 3 (Clientes, Histórico, Backup) + Tatame Clean visual redesign + Gerador de .exe + GitHub Release v1.0.0
Push para GitHub: **em dia** (branch `main`, último commit `3f471df`)
Release: **v1.0.0** publicada em https://github.com/alexmiguel011014-stack/ERP_HK/releases/tag/v1.0.0 com `JiuJitsu ERP Setup 1.0.0.exe` (80MB)
