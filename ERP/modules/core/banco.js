(function () {
  ...
  var banco = {
    ...
    produtos: {
      ...
      detalhados: function () { return invocar("listarProdutosDetalhados"); },
    ...
    /* ===== Clientes ===== */
    clientes: {
      listar: function () { return invocar("getClientes"); },
    ...
    compras: {
      ...
      receberPedido: function (pedidoId) { return invocar("receberPedidoCompra", pedidoId); },
