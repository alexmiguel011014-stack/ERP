(function () {
  ...
  var banco = {
    ...
    vendas: {
      ...
      importarHistorico: function (linhas) { return invocar("importarVendasHistoricas", linhas); },
    ...
    precificacao: {
      ...
      salvarCustoFixoConfig: function (mensal) { return invocar("saveCustoFixoConfig", mensal); },
