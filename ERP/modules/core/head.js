(function () {
  ...
  var ICONES_MENSAGEM = {
    ...
    sucesso: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>',
    ...
    aviso: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',
    info: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',
  };
  var TITULOS_MENSAGEM = {
    success: "Sucesso", sucesso: "Sucesso",
    error: "Erro", erro: "Erro",
    warning: "Atenção", aviso: "Atenção",
    info: "Informação",
  };
  ...
  function enriquecerMensagem(el) {
    ...
    if (el.querySelector(".mensagem-corpo") && el.getAttribute("data-ultimo-texto") === textoNovo) return;

    el.setAttribute("data-ultimo-texto", textoNovo);
    el.innerHTML =
      '<div class="mensagem-titulo">' + (ICONES_MENSAGEM[tipo] || "") + "<span>" + (TITULOS_MENSAGEM[tipo] || "Aviso") + "</span></div>" +
  ...
  document.addEventListener("click", function (e) {
    if (e.target && e.target.classList && e.target.classList.contains("mensagem-fechar")) {
  ...
  function iniciarObservadorMensagens() {
    Array.prototype.forEach.call(document.querySelectorAll(".mensagem"), enriquecerMensagem);
